...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:premis="info:lc/xmlns/premis-v2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0" exclude-result-prefixes="xsi premis">
  ...
  <xsl:template match="premis:rights">
    <tr class="odd">
      <td class="islandora_premis_table_labels">
        <xsl:value-of select="name(premis:rightsStatement/premis:rightsStatementIdentifier/premis:rightsStatementIdentifierType)"/>
      </td>
      <td class="islandora_premis_table_values">
        <xsl:value-of select="premis:rightsStatement/premis:rightsStatementIdentifier/premis:rightsStatementIdentifierType"/>
      </td>
    </tr>
    <tr class="even">
      <td class="islandora_premis_table_labels">
        <xsl:value-of select="name(premis:rightsStatement/premis:rightsStatementIdentifier/premis:rightsStatementIdentifierValue)"/>
      </td>
      <td class="islandora_premis_table_values">
        <xsl:value-of select="premis:rightsStatement/premis:rightsStatementIdentifier/premis:rightsStatementIdentifierValue"/>
      </td>
    </tr>
    <tr class="odd">
      <td class="islandora_premis_table_labels">
        <xsl:value-of select="name(premis:rightsStatement/premis:rightsBasis)"/>
      </td>
      <td class="islandora_premis_table_values">
        <xsl:value-of select="premis:rightsStatement/premis:rightsBasis"/>
      </td>
    </tr>
    <tr>
      <td class="islandora_premis_table_labels">
