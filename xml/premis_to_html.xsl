...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:premis="info:lc/xmlns/premis-v2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0" exclude-result-prefixes="xsi premis">
  ...
  <xsl:template match="/premis:premis">
    <table id="premis_object" class="collapsible">
      <tr>
        <th colspan="2" bgcolor="#CCCCCC">PREMIS OBJECT</th>
      </tr>
      <tr>
        <th>Element Name</th>
        <th>Element Value</th>
    ...
    <table id="premis_event" class="collapsible">
      <tr>
        <th colspan="2" bgcolor="#CCCCCC">PREMIS EVENT</th>
      </tr>
      <tr>
        <th>Element Name</th>
        <th>Element Value</th>
    ...
    <table id="premis_agent" class="collapsible">
      <tr>
        <th colspan="2" bgcolor="#CCCCCC">PREMIS AGENT</th>
      </tr>
      <tr>
        <th>Element Name</th>
        <th>Element Value</th>
    ...
    <table id="premis_rights" class="collapsible">
      <tr>
        <th colspan="2" bgcolor="#CCCCCC">PREMIS RIGHTS</th>
      </tr>
      <tr>
        <th>Element Name</th>
        <th>Element Value</th>
  ...
  <xsl:template match="premis:object[@xsi:type='file']">
    <tr>
      <td colspan="2" bgcolor="#CCCCCC">
        <xsl:value-of select="name(premis:objectIdentifier)"/>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td colspan="2" bgcolor="#CCCCCC">
        <xsl:value-of select="name(premis:objectCharacteristics)"/>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td colspan="2" bgcolor="#CCCCCC">
        <xsl:value-of select="name(premis:objectCharacteristics/premis:fixity)"/>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td colspan="2" bgcolor="#CCCCCC">
        <xsl:value-of select="name(premis:objectCharacteristics/premis:format)"/>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td colspan="2" bgcolor="#CCCCCC">
        <xsl:value-of select="name(premis:storage)"/>
      </td>
    </tr>
    <tr>
      <td>
